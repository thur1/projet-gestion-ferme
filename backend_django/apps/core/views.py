...
from .models import (
    Enterprise, Farm, Species, Unit, Lot, LotDailyRecord, HealthEvent, StockItem, StockMovement, Membership
)
from .serializers import (
    EnterpriseSerializer, FarmSerializer, SpeciesSerializer, UnitSerializer, LotSerializer,
    LotDailyRecordSerializer, HealthEventSerializer, StockItemSerializer, StockMovementSerializer,
)
...
class DashboardSummaryView(APIView):
    ...
    def get(self, request):
        ...
        records_qs = LotDailyRecord.objects.filter(lot__unit__farm_id=farm_id, is_deleted=False, date__gte=last_7)
