...
export default function Register() {
  ...
  const benefits = [
    { icon: Sprout, label: 'Gestion simplifiée' },
    { icon: Users, label: 'Collaboration' },
    { icon: Zap, label: 'Gain de temps' },
    { icon: Award, label: 'Meilleurs résultats' }
  ];
        ...
        <div className="max-w-lg space-y-8">
          ...
          >
            ...
            <h1 className="text-5xl font-bold text-white leading-tight">
              Transformez votre ferme dès aujourd'hui
            </h1>
            <p className="text-xl text-gray-300">
              Rejoignez des centaines de fermiers qui optimisent leur production avec notre plateforme
            </p>
          </motion.div>
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                <benefit.icon className="w-5 h-5 text-farm-green" />
          ...
          >
            <p className="text-sm text-gray-400">
              ✓ Essai gratuit • ✓ Aucune carte bancaire requise • ✓ Support 7j/7
            </p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            ...
            <p className="text-gray-400">Commencez gratuitement</p>
          </div>
          ...
          >
            ...
            {success && (
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="rounded-lg bg-green-500/20 border border-green-500/50 p-3 mb-5 text-sm text-green-200"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-transparent text-gray-400">Vous avez déjà un compte ?</span>
                </div>
              </div>
          ...
          >
            {benefits.map((benefit) => (
              <div key={benefit.label} className="flex items-center space-x-2 text-gray-400">
                <benefit.icon className="w-4 h-4 text-farm-green" />
          ...
          <motion.div
            ...
            className="lg:hidden text-center mt-6 text-xs text-gray-500"
          >
            Essai gratuit • Aucune carte bancaire • Support 7j/7
          </motion.div>
        </div>
      </motion.div>
    </div>
